Rails.application.config.sorcery.submodules = [:user_activation, :http_basic_auth, :remember_me, :reset_password, :brute_force_protection, :activity_logging, :external]
